      ...
      <div className="rounded-xl border border-base-border bg-base-surface p-5">
        ...
        {!showForm ? (
          <button
            ...
            className="mt-4 rounded-lg bg-pitch px-4 py-2.5 font-semibold text-base"
          >
            Report result
          </button>
        ) : (
          <form onSubmit={handleSubmitResult} className="mt-4 space-y-4">
            ...
            <div>
              ...
              <input
                ...
                className="w-full text-sm text-ink-dim file:mr-3 file:rounded-lg file:border-0 file:bg-base-raised file:px-3 file:py-2 file:text-ink"
              />
            ...
            <div className="flex gap-2">
              ...
              <button
                ...
                className="rounded-lg border border-base-border px-4 py-2.5 font-semibold text-ink-dim"
              >
                Cancel
              </button>
            </div>
