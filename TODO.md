...
- [ ] **Notifications**: email or push alert when someone joins your room,
      or when a result needs your approval.
...
- [ ] **Leaderboards / stats**: win rate, total tokens won, per-player
      match history page.
